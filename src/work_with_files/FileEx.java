...
public class FileEx {
    public static void main(String[] args) throws IOException {
        ...
        File folder = new File("C:\\Users\\m.baitanatov\\Desktop\\A");
        File file2 = new File("C:\\Users\\m.baitanatov\\Desktop\\A\\test1.txt");
        File folder2 = new File("C:\\Users\\m.baitanatov\\Desktop\\B");
...
//        System.out.println("folder.delete " + folder.delete()); // когда папка содержит файлы удалить ее нельзя
