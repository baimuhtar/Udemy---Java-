...
public class TreeSetEx2 {
    public static void main(String[] args) {
        ...
        System.out.println(treeSet.subSet(st6,st7)); // больше или равно ... и меньше ...
        System.out.println(st3.equals(st6)); // Если сравниваем по курсу, то и equals с hashcode должны проверять по курсу
