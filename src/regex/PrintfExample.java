...
public class PrintfExample {
    ...
    public static void main(String[] args) {
        //System.out.printf("string - nujno viravnit gj levomu krayu" + "a vtoroy parament - double, nado okruglit do desyatyx", "privet", "3.1415");

        Employee emp1 = new Employee(1, "Zaur", "Trgulov", 12345, 0.15);
        Employee emp2 = new Employee(15, "Ivan", "Petrov", 6542, 0.08);
        Employee emp3 = new Employee(123, "Mariya", "Sidorova", 85424, 0.12);
